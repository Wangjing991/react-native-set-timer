import { NativeEventEmitter, NativeModules,Platform } from "react-native";
	...
	const eventEmitter =  RNBackgroundTimerAndroid ? new NativeEventEmitter(RNBackgroundTimerAndroid) :{ };
	const timerDataMap = {};
	let uniqueIdCounter = 0;

 RNBackgroundTimerAndroid && eventEmitter.addListener(RNBackgroundTimerAndroid.TIMER_EVENT, id => {
